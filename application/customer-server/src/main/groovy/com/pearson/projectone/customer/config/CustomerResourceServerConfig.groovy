...
class CustomerResourceServerConfig extends AbstractResourceServerConfig {
}
...
@EnableWebSecurity
@EnableGlobalMethodSecurity(prePostEnabled = true)
class DefaultCustomerSecurityConfig extends DefaultWebSecurityConfigurerAdapter {}
